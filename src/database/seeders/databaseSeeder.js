...
export default async function seedDatabase() {
  try {
    ...
    //*________________--------------- EMAIL GATEWAY -------------_____________________
    const rootEmailGateway = await emailGateway.bulkCreate([
      { company_id: "1", protocol: "smtp", host: "smtp.gmail.com", username: "harneetshahs@gmail.com", password: "jgtnxdsqmrldcivg", port: "587", encryption: "tls" },
    ]);

    //*________________--------------- MODULES -------------_____________________
    ...
    //*________________--------------- EXPORT REPORT -------------_____________________
    ...
    for (let a = 1; a <= 4; a++) {
      ...
      userIds.forEach(async (id) => {
        //*________________--------------- TIME -------------_____________________
