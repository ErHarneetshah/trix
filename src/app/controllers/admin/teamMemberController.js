...
class teamMemberController {
  ...
  addTeamMembers = async (req, res) => {
    ...
    try {
      ...
      const password =
        "$2b$10$moBYrpFMk0DJemIgdUqlgO4LXj5nUj0FK1zzV7GpEEmqh2yhcShVK"; // Test@123
    ...
    try {
      ...
      if (!existingTeamMember)
        return helper.failed(
          ...
          "User does not exists in your company data"
        );
      ...
      if (updateFields.email) {
        ...
        if (existingTeamMemberWithEmail)
          return helper.failed(
            res,
            variables.BadRequest,
            "Email is already used in system"
          );
      }
